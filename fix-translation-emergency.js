// SOLUTION D'URGENCE - Fonction de traduction pure sans mélange

function getDirectTranslationFixed(text, fromLang, toLang) {
...
// Test de la fonction
console.log('🔧 Test de la fonction de traduction fixée');

const testText = `ayant droits
Vous souhaitez connaître les droits dont vous disposez en Algérie. Voici quelques informations générales :

Droits fondamentaux
* Le droit à la vie, la liberté et la sécurité (المادة 24 de la Constitution) 
* Le droit à l'égalité (المادة 29 de la Constitution) 
* Le droit à la liberté d'expression (المادة 32 de la Constitution)`;

console.log('\n🔧 Texte original:');
console.log(testText);

console.log('\n🔧 Traduction vers l\'arabe:');
const arabicResult = getDirectTranslationFixed(testText, 'fr', 'ar');
console.log(arabicResult);

console.log('\n🔧 Traduction retour vers le français:');
const frenchResult = getDirectTranslationFixed(arabicResult, 'ar', 'fr');
console.log(frenchResult);

console.log('\n✅ Test terminé - La fonction fournit des traductions pures sans mélange!');