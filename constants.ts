...
export const UI_TRANSLATIONS = {
  fr: {
    ...
    menu_billing_new: "Facturation",
    menu_time_tracking: "Temps",
    menu_client_portal: "Portail Client",
  ...
  ar: {
    ...
    menu_admin: "إدارة",
    menu_docs: "وثائق",
    menu_clients: "العملاء",
    menu_calendar: "التقويم",
    menu_billing_new: "الفواتير",
    menu_time_tracking: "الوقت",
    menu_client_portal: "بوابة العميل",
